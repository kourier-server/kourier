...
ARG THREAD_COUNT
ENV SANITIZED_LLVM_INSTALLATION_DIR="/opt/llvm/${LLVM_VERSION}-asan-ubsan"
...
RUN --mount=target=/var/lib/apt/lists,type=cache \
    ...
    export LDFLAGS="-Wno-unused-command-line-argument -fno-omit-frame-pointer -rtlib=compiler-rt -shared-libsan -shared-libasan -stdlib=libc++ -Wl,-rpath,${SANITIZED_LLVM_INSTALLATION_DIR}/lib -Wl,-rpath,${SANITIZED_LLVM_INSTALLATION_DIR}/lib/${LLVM_HOST_TARGET} -Wl,-rpath,${SANITIZED_LLVM_INSTALLATION_DIR}/lib/clang/${LLVM_MAJOR_VERSION}/lib/${LLVM_HOST_TARGET} -L${LLVM_INSTALLATION_DIR}/lib -L${LLVM_INSTALLATION_DIR}/lib/${LLVM_HOST_TARGET} -L${LLVM_INSTALLATION_DIR}/lib/clang/${LLVM_MAJOR_VERSION}/lib/${LLVM_HOST_TARGET}"; \
